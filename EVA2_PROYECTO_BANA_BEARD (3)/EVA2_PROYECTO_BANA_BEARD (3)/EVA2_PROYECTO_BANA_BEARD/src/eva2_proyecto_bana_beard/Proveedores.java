...
public class Proveedores   { 
    ...
    String ruta = "C:\\INFORMACION DE PRODUCTOS\\";
    ...
    public void losProveedores(String ruta, String fileName) throws IOException{
        ...
        try (FileWriter fileWriter = new FileWriter(file); BufferedWriter bufWriter = new BufferedWriter(fileWriter)) {
            ...
            for (Proveedores proveedores : prove) {
                bufWriter.write("Cantidad: "+", "+proveedores.getCantidad()+" Precio: "+","+proveedores.getPrecio() +","+"Nombre Producto: "+proveedores.getNomproducto());
            }
